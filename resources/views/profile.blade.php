    ...
    <div class='container profile-shell'>
        <div class='profile-bar'>
            <div class='profile-avatar-col'>
                <img class="profile-image" src="../assets/images/user.png" alt="User-image">
            </div>
            <div class='profile-main-col'>
                <div class='d-flex w-100 justify-content-between align-items-start flex-wrap gap-2'>
        ...
        <div class='post-selector'>
            <div class='p-selector'>
                ...
                <h3 class='actived'>Invitation</h3>
                <h3 class='actived'>Question</h3>
