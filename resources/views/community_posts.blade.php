<x-app-layout>
    ...
    @php
        $posts = App\Models\Posts::where('type','=','community')->orderByRaw('RAND()')->get();
    @endphp
    <div class='posts'>
        <div>
                        ...
                        <div class='pdescription'>
                            ...
                            <div class='d-flex justify-content-between mt-4'>
                                <div class='d-flex w-75 gap-2'> 
                                    <i class="comments_id-{{$posts[$i]['id']}} fa-solid fa-comment fa-lg pt-2"></i><p class="counter-{{$posts[$i]['id']}}">{{$posts[$i]->comments()->count()}}</p><i class="fa-solid fa-box-open fa-lg pt-2"></i><p>5</p>
                                </div>
                                <p>Views:4k</p>
                            </div>
